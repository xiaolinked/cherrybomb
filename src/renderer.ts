...
export class Renderer {
  ...
  private drawEnemyIndex() {
    ...
    const enemies = [
      {
        name: "TRIANGLE (Standard)",
        color: "#FFD84D",
        desc: "Basic unit. Slow and predictable.",
        shape: "triangle",
      },
      {
        name: "DIAMOND (Fast)",
        color: "#FF3333",
        desc: "Speed demon. Charging speed is deadly.",
        shape: "diamond",
      },
      {
        name: "HEXAGON (Tank)",
        color: "#2ECC71",
        desc: "Heavily shielded. Takes massive damage.",
        shape: "hexagon",
      },
      {
        name: "SQUARE (Blinker)",
        color: "#A020F0",
        desc: "Periodically teleports closer to hero.",
        shape: "square",
      },
      {
        name: "OCTAGON (Splitter)",
        color: "#FF69B4",
        desc: "Splits into 3 minis upon death.",
        shape: "octagon",
      },
      {
        name: "CIRCLE (Mini)",
        color: "#FFA500",
        desc: "Spawned from Splitters. Fast and armed.",
        shape: "circle",
      },
    ];
